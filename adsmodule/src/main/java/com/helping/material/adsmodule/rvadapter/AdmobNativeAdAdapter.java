package com.helping.material.adsmodule.rvadapter;
...
import com.helping.material.adsmodule.AddIds;
import com.helping.material.adsmodule.MySharedPref;
import com.helping.material.adsmodule.NativeTemplateStyle;
import com.helping.material.adsmodule.R;
import com.helping.material.adsmodule.TemplateView;
...
//                        }
        ...
        if (mParam.forceReloadAdOnBind || !adHolder.loaded) {
            ...
            if(!mySharedPref.getBoolen(MySharedPref.Companion.getNATIVE_CALL())){
                adHolder.adContainer.setVisibility(View.GONE);
                return;
            }
